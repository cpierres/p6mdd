...
public class UserDto {
    ...
    @Schema(description = "Nom de l'utilisateur. Doit être unique car connexion possible via le nom.", example = "u1")
    private String username;

    @Schema(description = "Adresse email associée à l'utilisateur. Doit être unique", example = "u1@test.com")
